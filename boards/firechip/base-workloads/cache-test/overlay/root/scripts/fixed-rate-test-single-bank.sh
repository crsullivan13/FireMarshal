...
for ((i=0; i<ITERATIONS; i++)); do
  ...
  # Start BkPLL jobs
  for c in 1 2 3; do
    BkPLL -c $c -l 6 -b 0x78000 -m 32768 -e 1 -a write -x -i 9999999999 >"$run_dir/BkPLL_c${c}.log" 2>&1 &
  done
...
# for c in 1 2 3; do BkPLL -c $c -l 6 -b 0x78000 -m 32768 -e 1 -a write -x -i 9999999999 & done

# Bw -c 0 -t 1 -m 2048 -f victim

# devmem 0x21000000 32 0
# devmem 0x21000008 64 76800
# devmem 0x21000010 64 76800
# devmem 0x21000018 64 64
# devmem 0x21000050 64 0x2
# devmem 0x21000000 32 1