...
int main(int argc, char* argv[]) {
    ...
    unsigned long num_registers = 19; // Number of registers to read
    ...
    mapped_addr[15] = 0xffffffffffffffff;
    mapped_addr[16] = 0xffffffffffffffff;
    mapped_addr[17] = 0xffffffffffffffff;
    mapped_addr[18] = 0;
