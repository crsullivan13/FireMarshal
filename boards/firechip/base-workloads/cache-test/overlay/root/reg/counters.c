...
int main() {
    int fd;
    unsigned long base_address = 0x200000A8; // Starting address of the first register
    ...
    long unsigned int* vals = (long unsigned int*)malloc(sizeof(unsigned int)*num_registers);
